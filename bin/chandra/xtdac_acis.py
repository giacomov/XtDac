...
if __name__ == "__main__":
    ...
    for this_obsid in args.obsid:
        ...
        cmd_line = "xtc_filter_event_file.py --region_dir %s --in_package %s --out_package %s --emin %d --emax %d " \
        ...
        cmd_line = "xtc_prefilter_hot_pixels.py --evtfile %s --outfile %s" % (out_package.get('filtered_evt3').filename,
        ...
        cmd_line = "xtc_add_to_masterlist.py --package %s --masterfile %s" % (out_package.location, candidate_file)
