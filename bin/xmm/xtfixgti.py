...
import numpy
import logging
from XtDac.bin.xtdac import bayesian_blocks
...
parser.add_argument("-m", "--mode",
                    help="Mode: 'bblock' for Bayesian block (suggested), or 'fixed' (faster but less accurate)",
...
if __name__ == "__main__":
    ...
    log.info("Found %s events in file %s in CCD %i - %i (quadrant %s)" % (
    times.shape[0], args.eventfile, ccdmin, ccdmax, args.quadrant))
